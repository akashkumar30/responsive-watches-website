     ...
     <header class="header" id="header">
         <nav class="nav container">
             <a href="#" class="nav__logo">
                 <i class='bx bxs-watch nav__logo-icon'></i> Miner buddy
             </a>
         ...
         <section class="home" id="home">
             <div class="home__container container grid">
                 <div class="home__img-bg">
                     <img src="home2.webp" alt="" class="home__img">
                 </div>
                 ...
                 <div class="home__data">
                     <h1 class="home__title">NEW BITCOIN MINERS <br> COLLECTION B720</h1>
                     <p class="home__description">
                         Latest arrival of the new imported miners of the B720 series,
                         with high performance and more output.
                     </p>
                     ...
                     <div class="home__btns">
                         ...
                         <button class="button home__button">LOGIN</button>
                     </div>
                 </div>
             </div>
         </section>
         ...
         <section class="featured section container" id="featured">
             ...
             <div class="featured__container grid">
                 <article class="featured__card">
                     ...
                     <img src="mac1 (1).jpg" alt="" class="featured__img">

                     <div class="featured__data">
                         <h3 class="featured__title">MicroBT WhatsMiner M30S</h3>
                         <span class="featured__price">$1050</span>
                     </div>

                     <button class="button featured__button">Invest</button>
                 </article>

                 <article class="featured__card">
                     <span class="featured__tag">Sale</span>

                     <img src="mac3 (1).jpg" alt="" class="featured__img">

                     <div class="featured__data">
                         <h3 class="featured__title">open air miner</h3>
                 ...
                 <article class="featured__card">
                     ...
                     <img src="mac2 (1).jpg" alt="" class="featured__img">

                     <div class="featured__data">
                         <h3 class="featured__title">10 cipher miners rig</h3>
         ...
         <section class="story section container">
             <div class="story__container grid">
                 ...
                 <div class="story__images">
                     <img src="story2.png" alt="" class="story__img">
         ...
         <section class="testimonial section container">
             <div class="testimonial__container grid">
                 ...
                 <div class="testimonial__images">
                     ...
                     <img src="story2 (1).jpg" alt="" class="testimonial__img">
                 </div>
             </div>
         </section>
